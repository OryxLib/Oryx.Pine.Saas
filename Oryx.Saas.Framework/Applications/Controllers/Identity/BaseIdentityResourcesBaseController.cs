...
{
    public class BaseIdentityResourcesBaseController<T> : Controller
            where T : IdentityResource, new()
    {
        DbContext dbContext;
        ModelMapper modelMapper;
        public BaseIdentityResourcesBaseController(DbContext _dbContext)
        {
